...
class PlanController extends BaseController {
	...
	public function index()
	{
		...
		return View::make('pages.plan.admin.index', compact('plans', 'createAllowed'));
	}
	...
	public function create()
	{
		...
		return partial('common/modal_content', [
			...
			'modalBody'		=> View::make('pages.plan.admin.create', compact('users')),
			'modalFooter'	=> false,
		]);
	}
	...
	public function edit($id)
	{
		...
		return partial('common/modal_content', [
			...
			'modalBody'		=> View::make('pages.plan.admin.instructors', compact('plan', 'staff')),
			'modalFooter'	=> false,
		]);
	}
	...
	public function remove($id)
	{
		...
		return partial('common/modal_content', [
			...
			'modalBody'		=> View::make('pages.plan.admin.remove', compact('plan')),
			'modalFooter'	=> false,
		]);
	}
