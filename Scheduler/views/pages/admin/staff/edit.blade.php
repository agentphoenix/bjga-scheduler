					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-lg-12">
								@for ($d = 0; $d <=6; $d++)
									<div class="row">
										<div class="col-sm-4 col-md-3 col-lg-3"><strong>{{ $days[$d] }}</strong></div>
										<div class="col-sm-8 col-md-9 col-lg-9">
											<div class="form-group">
												{{ Form::text('schedule['.$d.']', $schedule->filter(function($s) use ($d){ return $s->day == $d; })->first()->availability, array('class' => 'form-control input-lg')) }}
											</div>
										</div>
									</div>
								@endfor
