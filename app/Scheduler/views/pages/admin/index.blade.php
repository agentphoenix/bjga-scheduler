		...
		<div class="col-md-6 col-lg-6">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<p><a href="{{ URL::route('admin.user.edit', array($_currentUser->id)) }}" class="btn btn-block btn-default">Edit My Account</a></p>
				</div>

				@if ($_currentUser->isStaff())
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<p><a href="{{ URL::route('admin.staff.edit', array($_currentUser->staff->id)) }}" class="btn btn-block btn-default">Edit My Staff Account</a></p>
					</div>
				@endif
			</div>
			...
			@if ($_currentUser->isStaff() and $_currentUser->access() > 1)
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<p><a href="{{ URL::route('admin.service.index') }}" class="btn btn-block btn-default">Manage Services</a></p>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<p><a href="{{ URL::route('admin.user.index') }}" class="btn btn-block btn-default">Manage Users</a></p>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<p><a href="{{ URL::route('admin.staff.index') }}" class="btn btn-block btn-default">Manage Staff</a></p>
					</div>
				</div>
			@endif
		</div>
