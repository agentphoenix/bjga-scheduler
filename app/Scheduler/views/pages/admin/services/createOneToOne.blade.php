...
@section('title')
	Create One-to-One Service
@endsection

@section('content')
	<h1>Create One-to-One Service</h1>
	...
	<p class="alert alert-warning">A One-to-One service is a service that has a single occurrence and participant. Examples of this include any private instruction.</p>
